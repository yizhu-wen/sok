...
def parse_args():
    ...
    parser.add_argument("--restore_path", type=str, help="pretrained FragmentVC checkpoint to fine-tune")
...
def main(
    ...
    if restore_path:
        model = torch.jit.load(restore_path, map_location=device).to(device)
    else:
