...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_dir', '-d', 
            default='data/LibriTTS/sr_24000_mel_norm')
    parser.add_argument('-train_set', default='train')
    parser.add_argument('-train_index_file', default='train_samples_64.json')
    parser.add_argument('-logdir', default='log/')
    parser.add_argument('--load_model', action='store_true')
    parser.add_argument('--load_opt', action='store_true')
    parser.add_argument('--restore_model_path', help='checkpoint to load model weights from without optimizer state')
    parser.add_argument('-store_model_path', default='experiments/adaptive_vc/model')
    parser.add_argument('-load_model_path', default='experiments/adaptive_vc/model')
